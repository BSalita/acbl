-- creating a sql file from json requires that this file be a complete schema. all .json fields must have table entries below.

-- todo
-- Redo SQL schema using API's json schema
...
-- reject 225K NULL board_scoring_method instances?
"board_scoring_method" VARCHAR NULL,
...
-- reject 1000 NULL tb_count e.g. club-results/106880/details/339368.data.sql?
"tb_count" REAL NULL,
...
"hasPbn" BOOL NULL,
"mp_engine" VARCHAR NULL,
"hr_delay" BOOL NULL,
"bwsfileExists" BOOL NULL,
-- accept the many NULL files instances. deprecated?
"files" VARCHAR NULL,
"board_sort" INT NULL,
"from_score" BOOL NULL,
"club" INT NOT NULL,
-- reject 250 NULL club_session instances?
"club_session" VARCHAR NULL,
"xmlFileExists" BOOL NULL,
"xmlFileURI" VARCHAR NULL,
"env" VARCHAR NULL ,
"stratvalues" VARCHAR NULL,
"mpLimits" VARCHAR NULL,
"club_director_name" VARCHAR NULL,
"mobile" BOOL NULL,
"sort_by_pair" BOOL NULL,
"game_type" INT NULL,
"strats" VARCHAR NULL,
"uploads" VARCHAR NULL,
"sessions" VARCHAR NOT NULL,
"is_mpengine_v2" BOOL NULL,
"is_virtual_game" BOOL NULL,
"latest_upload" VARCHAR NULL,
"transaction_date" VARCHAR NULL,
"virtualGameType" VARCHAR NULL,
"display_program_name" VARCHAR NULL,
"external_results_url" VARCHAR NULL,
"hasExternalResultsUrl" VARCHAR NULL,
"is_replayable" BOOL NULL,
-- list of VARCHAR
...
-- list of INTs
FOREIGN KEY ("latest_upload") REFERENCES "latest_upload"(id) ON DELETE NO ACTION
);
...
DROP TABLE IF EXISTS "latest_upload";

CREATE TABLE "latest_upload" (
"id" INT NOT NULL PRIMARY KEY,
"created_at" VARCHAR NOT NULL,
"updated_at" VARCHAR NULL,
"event_id" INT NOT NULL,
